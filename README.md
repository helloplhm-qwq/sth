...
这是从[[太长了点击跳转]](http://lyrics.kugou.com/download?ver=1&client=pc&id=103076179&accesskey=8F110C1A85C149513E23ADF22A769F3B&fmt=krc&charset=utf8)请求下来的数据（和音乐本体歌词来源相同）：  
```json
