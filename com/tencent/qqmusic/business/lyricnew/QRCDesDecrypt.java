/*  1 */ package com.tencent.qqmusic.business.lyricnew;@Metadata(d1 = {"\0004\n\002\030\002\n\002\030\002\n\000\n\002\020\013\n\002\b\004\n\002\020\005\n\000\n\002\020\f\n\000\n\002\020\b\n\000\n\002\020\022\n\002\b\002\n\002\020\016\n\002\b\007\030\000 \0272\0020\001:\001\027B\021\b\002\022\b\b\002\020\002\032\0020\003¢\006\002\020\004J\020\020\007\032\0020\b2\006\020\t\032\0020\nH\002J\031\020\013\032\0020\f2\006\020\r\032\0020\0162\006\020\017\032\0020\fH J\022\020\020\032\004\030\0010\0212\006\020\022\032\0020\021H\026J\022\020\023\032\004\030\0010\0162\006\020\024\032\0020\021H\002J\024\020\025\032\004\030\0010\0162\b\020\026\032\004\030\0010\016H\002R\021\020\002\032\0020\003¢\006\b\n\000\032\004\b\005\020\006¨\006\030"}, d2 = {"Lcom/tencent/qqmusic/business/lyricnew/QRCDesDecrypt;", "Lcom/lyricengine/base/LyricDecryptImpl;", "unzip", "", "(Z)V", "getUnzip", "()Z", "charToByte", "", "c", "", "desDecrypt", "", "buffer", "", "len", "doDecryptionLyric", "", "content", "hexStringToBytes", "hexString", "unZipByte", "data", "Companion", "qqmusic_release"}, k = 1, mv = {1, 5, 1}, xi = 48) public final class QRCDesDecrypt implements c { @NotNull public static final a Companion = new a(); @NotNull private static final String TAG = "QRCDesDecrypt"; @Nullable private static QRCDesDecrypt mInstance; @NotNull private static final LruCache<String, String> mLyricCache = new LruCache(4); private final boolean unzip; private QRCDesDecrypt(boolean paramBoolean) { this.unzip = paramBoolean; } private final byte[] hexStringToBytes(String paramString) { byte[] arrayOfByte = SwordSwitches.switches8; if (arrayOfByte != null && (arrayOfByte[239] >> 6 & 0x1) > 0) { SwordProxyResult swordProxyResult = SwordProxy.proxyOneArg(paramString, this, 80319); if (swordProxyResult.isSupported) return (byte[])swordProxyResult.result;  }  if (paramString != null) try { if (paramString.length() > 0)
/*  2 */         { paramString = paramString.toUpperCase(); t.f(paramString, "this as java.lang.String).toUpperCase()");
/*  3 */           int i = paramString.length() / 2;
/*  4 */           char[] arrayOfChar = paramString.toCharArray(); t.f(arrayOfChar, "this as java.lang.String).toCharArray()");
/*  5 */           byte[] arrayOfByte1 = new byte[i]; int j = 0; if (i > 0) while (true) { int k = j + 1, m = j * 2;
/*  6 */               byte b = charToByte(arrayOfChar[m]); arrayOfByte1[j] = (byte)(charToByte(arrayOfChar[m + 1]) | b << 4); if (k >= i) break;  j = k; }   return arrayOfByte1; }  } catch (Exception exception)
/*  7 */       { MLog.e("QRCDesDecrypt", exception); }   return null; } @Nullable public String doDecryptionLyric(@NotNull String paramString) { String str1; byte[] arrayOfByte = SwordSwitches.switches8; if (arrayOfByte != null && (arrayOfByte[220] >> 2 & 0x1) > 0) { SwordProxyResult swordProxyResult = SwordProxy.proxyOneArg(paramString, this, 80163); if (swordProxyResult.isSupported) return (String)swordProxyResult.result;  }  t.g(paramString, "content"); String str2 = t.p("key_", Integer.valueOf(paramString.hashCode())); try { String str = (String)mLyricCache.get(str2); } finally { Exception exception = null; arrayOfByte = null; }  try { String str; byte[] arrayOfByte2 = hexStringToBytes(paramString); if (arrayOfByte2 == null)
/*  8 */         return null;  
/*  9 */       try { desDecrypt(arrayOfByte2, arrayOfByte2.length); } catch (UnsatisfiedLinkError unsatisfiedLinkError)
/* 10 */       { com.tencent.mediaplayer.a.f("desdecrypt", null, 2, null);
/* 11 */         desDecrypt(arrayOfByte2, arrayOfByte2.length); }
/* 12 */        byte[] arrayOfByte1 = arrayOfByte2; if (this.unzip)
/* 13 */         arrayOfByte1 = unZipByte(arrayOfByte2);  if (arrayOfByte1 == null)
/* 14 */         return null;  }
/*    */     finally
/* 16 */     { Exception exception = null;
/* 17 */       MLog.e("QRCDesDecrypt", exception); }
/* 18 */      t.e(paramString); return paramString; }
/*    */ 
/*    */   
...
/* Location:              E:\code1\QM\QM_lyric.jar!\com\tencent\qqmusic\business\lyricnew\QRCDesDecrypt.class
